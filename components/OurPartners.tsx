...
//           KIMS-USHALAKSHMI Centre for Breast Diseases is South Asia’s first comprehensive Breast Centre and Ushalakshmi Breast Cancer Foundation is a Charity devoted towards championing Breast Cancer advocacy and Screening. 
//         </div>
//       </div>
...
export default function OurPartners() {
  return (
    <section className="py-20 lg:py-28 bg-white px-6 text-lg leading-relaxed">
      
      {/* HEADER */}
      <div className="text-center mb-14">
        <h2 className="text-4xl sm:text-5xl font-bold text-teal-600 mb-4">
          Our Partners
        </h2>
        <p className="text-lg sm:text-xl text-teal-700 max-w-2xl mx-auto">
          Collaborating with leading healthcare organizations worldwide
        </p>
      </div>

      {/* LOGOS */}
      <div className="flex flex-wrap items-center justify-center gap-16 mb-14">
        {partners.map((partner, index) => (
          <Link
            key={index}
            href={partner.url}
          ...
          >
            <Image
              src={partner.logo}
              alt="Partner logo"
              width={partner.size === 'large' ? 280 : 200}
              height={partner.size === 'large' ? 140 : 100}
              className={`object-contain ${
                partner.size === 'large'
                  ? 'h-24 sm:h-28'
                  : 'h-14 sm:h-16'
      ...
      {/* INFO STRIP */}
      <div className="max-w-6xl mx-auto mb-14">
        <div className="rounded-xl border border-blue-200 bg-blue-50 px-8 py-6 text-center text-lg text-gray-800 italic">
          KIMS-USHALAKSHMI Centre for Breast Diseases is South Asia’s first
          comprehensive Breast Centre and Ushalakshmi Breast Cancer Foundation is
          a charity devoted to championing breast cancer advocacy and screening.
        </div>
      </div>

      {/* OPTIONAL PARTNERSHIP ANNOUNCEMENT (kept commented) */}
      {/*
      <div className="max-w-6xl mx-auto mb-16">
        <div className="relative rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 px-8 py-8 pl-20 shadow-sm">
          
          <div className="absolute left-0 top-0 h-full w-2 bg-blue-700 rounded-l-2xl" />

          <div className="absolute left-6 top-8 flex h-10 w-10 items-center justify-center rounded-full bg-blue-100">
