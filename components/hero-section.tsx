  ...
  return (
    <section className="px-6 sm:px-10 lg:px-16 py-12 lg:py-20">
      ...
      <motion.div
        ...
        className="flex justify-center mb-10"
      >
        <span className="inline-flex items-center rounded-full bg-orange-100 px-5 py-2 text-sm font-semibold text-orange-600 shadow-sm border border-orange-200">
          🚀 Now in Beta
        </span>
      </motion.div>
